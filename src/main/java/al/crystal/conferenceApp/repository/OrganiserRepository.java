...
public interface OrganiserRepository extends JpaRepository<Organiser, Long> {
    ...
    @Query(value = "Select o.id, o.biography, o.company_name, o.facebook_url,o.instagram_url,o.linkedin_url,o.tweeter_url from conferencedb.organiser o where o.id =:id", nativeQuery = true)
